  ...
  template: `
    <div class="container">
      ...
      <div class="card">
        ...
        <div class="text-center mt-3 mb-3">
          <p>
            No people found. Try a different search term or add a new person.
          </p>
        </div>
        } @else {
            ...
            <thead>
              <tr>
                <th (click)="sortBy('id')" style="cursor: pointer">
                  ID @if (sortColumn === 'id') { @if (sortDirection === 'asc') {
                  ↑ } @else { ↓ } }
                </th>
                <th (click)="sortBy('name')" style="cursor: pointer">
                  Name @if (sortColumn === 'name') { @if (sortDirection ===
                  'asc') { ↑ } @else { ↓ } }
                </th>
                <th (click)="sortBy('email')" style="cursor: pointer">
                  Email @if (sortColumn === 'email') { @if (sortDirection ===
                  'asc') { ↑ } @else { ↓ } }
                </th>
                <th>Phone</th>
                <th>Company</th>
